...
insert  into `realmcharacters`(`realmid`,`acctid`,`numchars`) values (1,1,0),(1,2,0),(1,3,0),(1,4,1),(2,3,0),(2,4,0);
...
insert  into `realmlist`(`id`,`name`,`address`,`port`,`icon`,`flag`,`timezone`,`allowedSecurityLevel`,`motd`,`population`,`gamebuild`,`online`,`delay`,`queue`,`lastupdate`) values (1,'Дренор','127.0.0.1',8085,0,0,1,0,'Welcome to World of Warcraft Warlords of Draenor',0,20779,0,10,0,1509725057);
